...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <form method="post" action="<?php echo base_url()."user/Family_Head_Reports_by_cities_pdf_report"; ?>" target="_blank">
            <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div>
                        ...
                        <label class="label">Please Select City</label>
                          <select name="brand" id="brand" class="btn btn-default btn-block col-md-12 col-sm-12 col-xs-12 select" required>
