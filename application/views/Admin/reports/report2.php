...
<th scope="col" style="width: 150px !important; font-size: 12px; margin-top:-20;text-align: center;">Family Members</th>





      <th scope="col" style=" padding:7px 0 0px 0px !important; text-align:center; font-size: 12px; width: 20px; height: auto !important; display: table-cell;">Relationship
 </br>
 ...
 <ul style="margin-top:10px; text-align:left;">
  ...
  <li>7-Others</li>
    ...
    /*display: inline !important;">1</th> 
      ...
      <td>  <div class="testting" style="margin:0 auto;display: inline-block;"></div>  </td>
      <td>  <div class="testting" style="margin:0 auto;display: inline-block;"></div>  </td>
  <td> 
<!--   <div style="display: flex; flex-wrap:nowrap;  "> 
 ...
 <td>  <div class="testting" style="margin:0 auto;display: inline-block;"></div>  </td>
  ...
  <tr>
      ...
      <td> <div class="testting" style="margin:0 auto;display: inline-block;"></div>  </td>
      <td>  <div class="testting" style="margin:0 auto;display: inline-block;"></div>  </td>
      <td> <!--  <div class="testting" style="margin-left:15px;margin-top:3px;width:15px;  "></div>  
