...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div>  
            ...
            <h4 class="heading4">View Reports By Province</h4>
        </div>
        <form method="post" action="<?php echo base_url()."user/pdf_report_loation"; ?>" target="_blank">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-4 col-sm-offset-4 col-xs-offset-4 new">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <option value="<?php echo $datas->ProvName; ; ?>"><?php echo $datas->ProvName; ; ?></option>
                        <?php } ?>
                        </select>
