    ...
    <section class="content">
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <form action="<?php echo base_url('user/child_to_head_create_fn')?>" id="myform" method="POST">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="FirstName" id="FirstName" placeholder="First Name" value="<?php echo $FamilyID[0]['MemberName'];?>" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="MiddleName">Middle Name <span class="required"
                                                style="color:red">*</span></label>
                                        <input type="text" class="form-control"  name="MiddleName" id="MiddleName" placeholder="Middle Name" value="" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="HFCNIC" id="HFCNIC"
                                            placeholder="00000-0000000-0" value="<?php echo $FamilyID[0]['MemberCNIC'];?>" data-mask="00000-0000000-0">
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="FatherFirstName" id="FatherFirstName"
                                            placeholder="FatherFirstName" value="<?php echo $FInfo[0]['FirstName'];?>">
                                    </div>
                                    <div class="form-group col-md-3">
                                ...
                                <div class="panel-body">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="HeadID" class="form-control" readonly name="HeadID"
                                            data-inputmask="00000" value="<?php echo $FInfo[0]['ID'];?>">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="MobileNo" name="MobileNo" class="form-control" required
                                            data-inputmask="(+92) 000-0000000" value="" placeholder="(+92) xxx xxxxxxx">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="Email">Email address <span class="required"
                                                style="color: red">*</span></label>
                                        <input type="Email" class="form-control"  onkeyup="newEmail()" value="" name="Email" id="Email"
