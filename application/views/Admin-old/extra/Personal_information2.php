      ...
      <?php 
          foreach ($testing as $key){?>          
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <input type="text" id="first_name1" name="FirstName" placeholder="First Name" required="required" class="form-control col-md-7 col-xs-12 input-sm" value="<?php echo $key['HFCNIC']; ?>">
                    </div>                            

                    <div class="col-md-3 col-sm-3 col-xs-12">
                      <label class="col-md-12 col-sm-12 col-xs-12" for="name">Middle Name <span class="required" style="color:red">*</span>
                      </label>
                      <input type="text" id="middle_name1"  name="MiddleName" placeholder="Middle Name" required="required" class="form-control col-md-7 col-xs-12 input-sm" value="<?php  echo $key['MiddleName']; ?>">
                    </div>    
                         
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      <label class="col-md-12 col-sm-12 col-xs-12" for="name">Last Name <span class="required" style="color:red"></span>
                      </label>
                      <input type="text" placeholder="Last Name" value="<?php echo   $key['LastName']; ?>" id="last_name1"  name="LastName"  class="form-control col-md-7 col-xs-12 input-sm">
                    </div>
                    
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      <label class="col-md-12 col-sm-12 col-xs-12" for="name">CNIC <span style="color: red">*</span>
                      </label>
                      <input type="text" id="cnic2" name="HFCNIC" class="form-control col-md-7 col-xs-12 input-sm" data-mask="00000-0000000-0" required placeholder="xxxxx-xxxxxxx-x"  value="<?php echo $key['HFCNIC']; ?>">
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <input type="text" id="first_name2"  name="FatherFirstName" placeholder="First Name" required="required" class="form-control col-md-7 col-xs-12 input-sm" value="<?php echo $key['FatherFirstName']; ?>">
                    </div>                            
                              
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      <label class="col-md-12 col-sm-12 col-xs-12" for="name">Middle Name <span class="required" style="color:red">*</span>
                      </label>
                      <input type="text" id="middle_name2"  name="FatherMiddleName" placeholder="Middle Name" class="form-control col-md-7 col-xs-12 input-sm" value="<?php echo $key['FatherMiddleName']; ?>"  required>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <input type="text" placeholder="Last Name" id="last_name2"  name="FatherLastName""  class="form-control col-md-7 col-xs-12 input-sm" value="<?php echo $key['FatherLastName']; ?>">
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 temp_change">  
                      ...
                      <input type="text" id="cnic2"  name="FatherCNIC" class="form-control col-md-7 col-xs-12 input-sm" data-mask="00000-0000000-0" placeholder="xxxxx-xxxxxxx-x" value="<?php echo $key['FatherCNIC']; ?>"  required>
                    </div>
                  </div>
                  ...
                  <div class="form-group col-sm-4 col-md-4 col-xs-12 personal box2">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">  
                      ...
                      <input type="text" id="HeadID" readonly  name="HeadID" data-mask="00000" placeholder="xxxxx"  class="form-control col-md-7 col-xs-12 input-sm" value="<?php echo $key['HeadID']; ?>" required>
                    </div>                            
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" id="contact1" readonly name="MobileNo"   class="form-control col-md-7 col-xs-12 input-sm" required="" data-mask="(+92) 000-0000000" placeholder="(+92) xxx xxxxxxx" value="<?php echo $key['MobileNo']; ?>">
                  </div>
<!-- 
                  <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" id="email"  name="Email"  readonly class="form-control col-md-7 col-xs-12 input-sm" onkeyup="newEmail()" placeholder=" Not Mandatory" value="<?php echo $key['Email']; ?>">
                  </div>
                ...
                <div class="form-group  col-sm-12 col-md-12 col-xs-12 personal">
                  <h5 class="headings">Address</h5>
                    <div class="col-md-3 col-sm-3 col-xs-12">  
                      ...
                      <!-- data-mask="A-9999" -->
                      <input type="text" id="address1"  name="Address1"  placeholder="A-1234" class="form-control col-md-2 col-xs-12  input-sm" value="<?php echo $key['Address1']; ?>" required></input>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">  
                      ...
                      <!-- data-mask="A-9999" -->
                      <input type="text" id="address2"  name="Address2"  placeholder="A-1234" class="form-control col-md-2 col-xs-12  input-sm" value="<?php echo $key['Address2']; ?>"></input>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">  
                      ...
                      <input type="text" id="address"  name="BlockArea"  placeholder="Block/1234" class="form-control col-md-2 col-xs-12  input-sm" value="<?php echo $key['Block']; ?>" required=""></input>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">  
                      ...
                      <input type="text" id="postal"  name="PostalCode"  placeholder="Enter Postal" class="form-control col-md-2 col-xs-12 input-sm" data-mask="00000" value="<?php echo $key['PostalCode']; ?>"></input>
                    </div>
  <?php } ?> 
                    <div class="col-md-3 col-sm-3 col-xs-12">  
