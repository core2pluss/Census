...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update Head Of Family </li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box box-warning">
            <div class="box-header with-border">
                <h5 class="box-title">Update Head of Family</h5>
                <div class="box-tools pull-right">
                    <!-- <span class="label label-primary">Label</span> -->
                </div>
            </div>
            <div class="box-body">
                <form action="<?php echo base_url('user/personal_info_update_fn')?>" id="myform" method="POST">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="FirstName" id="FirstName" placeholder="First Name" value="<?php echo $Get_HOF[0]['FirstName']; ?>" required >
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="MiddleName">Middle Name <span class="required"
                                                style="color:red">*</span></label>
                                        <input type="text" class="form-control"  name="MiddleName" id="MiddleName" placeholder="Middle Name" value="<?php echo $Get_HOF[0]['MiddleName']; ?>" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="LastName">Last Name <span class="required"  style="color:red">*</span></label>
                                        <input type="text" class="form-control"  name="LastName" id="LastName" placeholder="Last Name" value="<?php echo $Get_HOF[0]['LastName']; ?>" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="HFCNIC">CNIC <span class="required"
                                                style="color:red">*</span></label>
                                        <input type="text" class="form-control" name="HFCNIC" id="HFCNIC"
                                            placeholder="00000-0000000-0" data-mask="00000-0000000-0" value="<?php echo $Get_HOF[0]['HFCNIC']; ?>">
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="FatherFirstName" id="FatherFirstName"
                                            placeholder="FatherFirstName" value="<?php echo $Get_HOF[0]['FatherFirstName']; ?>">
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="FatherMiddleName" id="FatherMiddleName"
                                            placeholder="Father Middle Name" value="<?php echo $Get_HOF[0]['FatherMiddleName']; ?>">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="FatherLastName">Last Name </label>
                                        <input type="text" class="form-control" name="FatherLastName" id="FatherLastName"
                                            placeholder="Father Last Name" value="<?php echo $Get_HOF[0]['FatherLastName']; ?>">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="FatherCNIC">CNIC <span class="required"
                                                style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="FatherCNIC" name="FatherCNIC"
                                            placeholder="00000-0000000-0" data-mask="00000-0000000-0" value="<?php echo $Get_HOF[0]['FatherCNIC']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="HeadID" class="form-control" readonly name="HeadID"
                                            data-inputmask="00000" value="<?php echo $Get_HOF[0]['HeadID']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="MobileNo">Contact # 1 <span class="required"
                                                style="color: red">*</span></label>
                                        <input type="text" id="MobileNo" name="MobileNo" class="form-control" required
                                            data-inputmask="(+92) 000-0000000" placeholder="(+92) xxx xxxxxxx" value="<?php echo $Get_HOF[0]['MobileNo']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="Email" class="form-control" name="Email" id="Email"
                                            placeholder="name@example.com" value="<?php echo $Get_HOF[0]['Email']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="address1" name="Address1"
                                            placeholder="A-1234" value="<?php echo $Get_HOF[0]['Address1']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="BlockArea" name="Block"
                                            placeholder="Block/1234" value="<?php echo $Get_HOF[0]['Block']; ?>">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="PostalCode">Postal Code <span class="required"
                                                style="color: red">*</span></label>
                                        <input type="text" class="form-control" id="PostalCode" name="PostalCode"
                                            placeholder="Enter Postal" value="<?php echo $Get_HOF[0]['PostalCode']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
